...
REVIEWER_SYSTEM = (
    ...
    "【发布前自检（按篇幅判断，不要机械套模板）】短评只要有明确体验感和 1-2 个真实细节也可高分；"
    "中长评再看具体消费时间 / 同行人员 / 1-2 个具体项目或产品 / 服务或环境 / 合理小遗憾。"
    "重点看是否像真人随手写，而不是结构是否完整。"
    "避开所有高风险禁用词 / 字数符合平台 / 语气自然口语化 / 有互动引导（小红书/抖音）。"
    "不得因为不是三段式、篇幅简短而扣分；不得因为正文未出现店名或人均花费扣分。\n\n"
